...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_directional(
      ...
      ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_VOLU, KC_PGUP,
      ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_VOLD, KC_PGDN
      ),
};
